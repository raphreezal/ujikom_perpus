    ...
    <div class="container-fluid py-4">
      ...
      background-size: cover;">
                  ...
                  <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                      <i class="fa-solid fa-circle-info text-dark opacity-10"></i>
                  </div>
                  <h5 class="text-white mb-1">Petualangan Baru Naruto!</h5>
                  <p>Masashi Kishimoto selaku penulis manga Naruto mengumumkan bahwa akan ada petualangan baru dari Naruto.</p>
      ...
      background-size: cover;">
                  ...
                  <h5 class="text-white mb-1">J.K. Rowling Hiatus?</h5>
                  <p>Kabar mengejutkan datang dari salah satu penulis seri "Harry Potter" mengenai keputusannya untuk mengambil jeda dari pekerjaannya.</p>
