                        ...
                        <div class="card-body">
                            ...
                            <form class="user" method="post" action="<?= base_url('auth/register'); ?>">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Nama lengkap Pengguna" value="<?= set_value('name'); ?>" aria-label="Nama lengkap">
                                    <?= form_error('name', '<small class="text-danger pl-3" style="font-size:0.75rem">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user" id="email" name="email" placeholder="Masukkan alamat email" value="<?= set_value('email'); ?>" aria-label="Email">
                                    <?= form_error('email', '<small class="text-danger pl-3" style="font-size:0.75rem">', '</small>'); ?>
                                </div>
                                <div class="mb-3">
                                    <input type="password" class="form-control" id="password1" name="password1" placeholder="Buat Kata Sandi" aria-label="Kata Sandi">
                                    <?= form_error('password1', '<small class="text-danger pl-3" style="font-size:0.75rem">', '</small>'); ?>
                                </div>
                                <div class="mb-3">
                                    <input type="password" class="form-control" id="password2" name="password2" placeholder="Ulangi Kata Sandi" aria-label="Ulangi Kata Sandi">
                                ...
                                <p class="text -sm mt-3 mb-0">Sudah punya akun? <a href="<?= base_url('auth'); ?>" class="text-dark font-weight-bolder">Masuk Sekarang!</a></p>
                            </form>
                        </div>
                    </div>
                </div>
